...
generate_table_2 <- function(pricing_results,
  ...
  latex_lines <- c(latex_lines,
                   ...
                   "Test assets are the 83 bond and stock portfolios and the 40 tradable bond and stock factors (Panel A), the 50 bond portfolios and  16 tradable bond factors (Panel B), and the 33 stock portfolios and 24 tradable stock factors (Panel C), respectively.",
...
generate_table_3 <- function(pricing_results,
  ...
  latex_lines <- c(latex_lines,
                   ...
                   "The IS test assets are the same as in Table \\ref{tab:tab-is-pricing-excess}. OS test assets are the combined 154 bond and stock portfolios (Panel A), as well as the separate 77 bond and stock portfolios (Panels B and C).",
                   "All data are standardized, that is, pricing errors are in Sharpe ratio units. The sample period is 1986:01 to 2022:12 ($T=444$).",
                   "}",
                   "\\end{spacing}",
                   "\\vspace{-4mm}",
