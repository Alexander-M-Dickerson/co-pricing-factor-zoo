...
Table A.1 is [factors-reference.md](../factors-reference.md), which groups the 54 factors into 16 traded bond factors, 24 traded equity factors, and 14 nontraded factors and summarizes their construction.
