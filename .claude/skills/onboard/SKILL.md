...
3. Use `tools/bootstrap_packages.R --check` or the PowerShell wrapper to determine package gaps.
4. Use `docs/manifests/data-files.csv` as the exact input checklist.
5. Run `tools/doctor.R` or `tools/doctor.ps1` to verify packages, data, toolchain visibility, and fast backend readiness.
