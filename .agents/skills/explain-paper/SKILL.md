---
name: "explain-paper"
description: "Explain the paper, methods, factors, tables, figures, and code paths for this repo. Use when Codex needs to answer a paper question, trace an exhibit back to code, or connect saved results to equations and manuscript claims."
---
